...
namespace Sang.AspNetCore.RoleBasedAuthorization
{
    ...
    internal sealed class ResourceAuthorizationPolicyProvider : IAuthorizationPolicyProvider
    {
        ...
        {
            Log.WriteLog($"####GetDefaultPolicyAsync:{_options.DefaultPolicy.ToString()}", Log.LogType.Information);
        ...
        public Task<AuthorizationPolicy> GetPolicyAsync(string policyName)
        {
            ...
            if (policy is null)
            {
                ...
                Log.WriteLog($"#####GetPolicyAsync:{policyName}", Log.LogType.Information);
            }
