...
{
    private readonly ILogger<MyRolePermission> _logger;
    ...
    public MyRolePermission(IMemoryCache memoryCache, IServiceProvider _sp,ILogger<MyRolePermission> logger)
    {
